    ...
    if (isEditMode) {
      const fetchRestaurant = async () => {
        try {
          ...
          const response = await fetch(`http://127.0.0.1:8000/api/restaurant/show/${id}`, {
            headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const url = isEditMode
        ? `http://127.0.0.1:8000/api/restaurant/edit/${id}`
        : "http://127.0.0.1:8000/api/restaurant/create";
